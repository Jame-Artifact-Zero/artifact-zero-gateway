...
def nti_run():
    ...
    nii_detail = nii.get("detail", {}) if isinstance(nii, dict) else {}
    legacy_v1 = {
        "nii_score": nii_detail.get("nii_score"),
        "nii_raw": nii_detail.get("nii_raw"),
        "nii_label": nii_detail.get("nii_label"),
        "dominance": dominance,
        "dominance_detected": dominance,
        "udds_state": udds.get("state") or udds.get("udds_state") or udds.get("signal", ""),
        "dce_state": dce.get("state") or dce.get("dce_state") or dce.get("signal", ""),
        "cca_state": cca.get("state") or cca.get("cca_state") or cca.get("signal", ""),
        "failure_modes": {
            "UDDS": udds,
            "DCE": dce,
            "CCA": cca,
    ...
    result = {
        ...
        "nii": nii,
        "nii_score": legacy_v1["nii_score"],
        "nii_raw": legacy_v1["nii_raw"],
        "nii_label": legacy_v1["nii_label"],
        "udds_state": legacy_v1["udds_state"],
        "dce_state": legacy_v1["dce_state"],
        "cca_state": legacy_v1["cca_state"],
        "v1": legacy_v1,
        "score": legacy_v1,
        "tilt_taxonomy": tilt,
        "signals": signals,
