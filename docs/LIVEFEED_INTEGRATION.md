...
RSS feeds are published by news organizations specifically for syndication and third-party consumption. We display:
...
The NTI analysis is our original structural analysis applied to the text — this is transformative use.

The whitelist in rss_proxy.py restricts fetching to only approved news domains for security.
